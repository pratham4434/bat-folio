...
const Form = () => {
    ...
    const formSubmitHandler = (e) => {
        ...
        send(
            "service_cvnyvxp", // Service ID
            "template_71idevp", // Template ID
            userInput,
            "GBEke_c5-x6fwYZwL" // Public Key - https://dashboard.emailjs.com/admin/account
        )
            .then((response) => {
    ...
    const formSuccess = () => {
        toast(
            "Behold! Batman will get to you in no time."
        );
            ...
            >
                ...
                <div className="flex flex-col gap-2">
                    <label
                        ...
                        className="text-[16px] text-white uppercase"
                    >
                        Tell BATMAN more about your problem
                        <sup>*</sup>
                    </label>
                    <textarea
                        name="message"
